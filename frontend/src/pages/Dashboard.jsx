      ...
      try {
        ...
        if (!startDate) {
          try {
            ...
            startDate = toISODate(addDays(new Date(), -90))
            setUserStartDate(startDate)
            // Error occurred, using 90 days ago as fallback
          }
        }
        
        // Fetching cumulative data
        ...
        // State updated with cumulative data
      } finally {
        setLoading(false)
      }
    }
