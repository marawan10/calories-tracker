...
export const GOOGLE_FIT_CONFIG = {
  ...
  CLIENT_ID: import.meta.env.VITE_GOOGLE_FIT_CLIENT_ID || 'your-google-client-id.apps.googleusercontent.com',
  API_KEY: import.meta.env.VITE_GOOGLE_FIT_API_KEY || 'your-google-api-key',
