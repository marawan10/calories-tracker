...
import { Menu, X, BarChart3, ClipboardList, UtensilsCrossed, PieChart, Activity } from 'lucide-react'
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            className="fixed top-0 left-0 h-full w-80 bg-white/95 backdrop-blur-md border-r border-slate-200/50 z-50 md:hidden"
